...
public class Handler implements RequestHandler<S3Event, String> {
  ...
  private static final float MAX_WIDTH = Float.parseFloat(System.getenv("ENV_MAX_WIDTH"));
  private static final float MAX_HEIGHT = Float.parseFloat(System.getenv("ENV_MAX_HEIGHT"));
